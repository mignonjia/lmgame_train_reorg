...
# SINGLE_GPU="system.CUDA_VISIBLE_DEVICES=1 trainer.n_gpus_per_node=1"
...
THINK="agent_proxy.enable_think=True trainer.project_name=train_with_think"
NO_THINK="agent_proxy.enable_think=False trainer.project_name=train_no_think"

# training task
CONFIG_NAME_SOKOBAN="_2_sokoban"
TRAIN_SOKOBAN="trainer.val_only=False trainer.total_training_steps=200 trainer.save_freq=100 es_manager.train.env_configs.tags=[SimpleSokoban]"

CONFIG_NAME_GSM8K="_7_gsm8k"
TRAIN_GSM8K="trainer.val_only=False trainer.total_training_steps=200 trainer.save_freq=100 es_manager.train.env_configs.tags=[GSM8K_NoThink_Turn_5]"

CONFIG_NAME_MIX="_8_mix"
TRAIN_MIX="trainer.val_only=False trainer.total_training_steps=200 trainer.save_freq=100 es_manager.train.env_configs.n_groups=[4,4] es_manager.train.env_configs.tags=[SimpleSokoban,GSM8K_NoThink_Turn_5]"
